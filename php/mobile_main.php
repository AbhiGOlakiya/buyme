...
<body>
    <div class="main" method="post">
        <div style="display:inline-flex;">
            <img alt="" src="https://m.media-amazon.com/images/I/21ghlFmBoIL._FMpng_SX200_.png" class="qa-title" width="30%">
            <div>

                <a href="ipad_main.php"><img src="https://m.media-amazon.com/images/I/61PnHlc0HCL._SX679_.jpg
       
" width="30%" height="90%" alt=""> </a>
            </div>
        </div>
        <div class="products">
            <div class="photo">
